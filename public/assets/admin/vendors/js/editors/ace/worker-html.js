...
module.exports={
	...
	"expected-attribute-name-but-got-eof":
		"Unexpected end of file. Expected attributes name instead.",
	"eof-in-attribute-name":
		"Unexpected end of file in attributes name.",
	"invalid-character-in-attribute-name":
		"Invalid character in attributes name.",
	"duplicate-attribute":
		"Dropped duplicate attributes '{name}' on tag.",
	"expected-end-of-tag-but-got-eof":
		"Unexpected end of file. Expected = or end of tag.",
	"expected-attribute-value-but-got-eof":
		"Unexpected end of file. Expected attributes value.",
	"expected-attribute-value-but-got-right-bracket":
		"Expected attributes value. Got '>' instead.",
	"unexpected-character-in-unquoted-attribute-value":
		"Unexpected character in unquoted attributes",
	"invalid-character-after-attribute-name":
		"Unexpected character after attributes name.",
	"unexpected-character-after-attribute-value":
		"Unexpected character after attributes value.",
	"eof-in-attribute-value-double-quote":
		"Unexpected end of file in attributes value (\").",
	"eof-in-attribute-value-single-quote":
		"Unexpected end of file in attributes value (').",
	"eof-in-attribute-value-no-quotes":
		"Unexpected end of file in attributes value.",
	"eof-after-attribute-value":
		"Unexpected end of file after attributes value.",
