            ...
            <div class="content-body">
                ...
                <div class="row match-height">
                    <div class="col-12 col-xl-8">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{__('messages.new orders')}}</h4>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-de mb-0">
                                        ...
                                        <tr class="bg-success bg-lighten-5">
                                            <td>10583.4</td>
                                            <td>{{__('messages.ali osama')}}</td>
                                            <td>$ 4762.53</td>
                                            <td>{{__('messages.complete')}}</td>
                                            <td>$ 4762.53</td>
                                        </tr>
                    ...
                    <div class="col-12 col-xl-4">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{__('messages.last feed')}}</h4>
                                <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                                <div class="heading-elements">
                                </div>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-de mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <th>{{__('messages.feed')}}</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <tr class="bg-danger bg-lighten-5">
                                            <td>{{__('messages.ali osama')}}</td>
                                            <td><i class="cc BTC-alt"></i> {{__('messages.ring')}}</td>
                                            <td>10</td>
                                        </tr>
