            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item">
                    <a class="navbar-brand" href="index.html">
                        ...
                        <h3 class="brand-text">{{__('admin/header.modern admin')}}</h3>
                    </a>
                </li>
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span class="mr-1">{{__('admin/header.hello')}}
                  ...
                  <img style="height: 35px;" src="{{asset('assets/admin/images/portrait/small/IMG_20181031_221951.jpg')}}" alt="avatar"><i></i></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="{{route('edit.profile')}}"><i
                                    class="ft-user"></i> {{__('admin/header.editprof')}} </a>
                          ...
                          <img src="{{asset('assets/admin/images/portrait/small/avatar-s-2.png')}}" alt="avatar"><i></i></span>
                                ...
                                <a href="javascript:void(0)">
                                    <div class="media">
                                        <div class="media-left">
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="{{asset('assets/admin/images/portrait/small/IMG_20181031_221951.jpg')}}"
                               alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
