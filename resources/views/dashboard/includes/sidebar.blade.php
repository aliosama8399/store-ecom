    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                ...
                <ul class="menu-content">
                    <li class="{{'admin.products'== request()->path() ? 'active' : ''}}"><a class="menu-item" href="{{route('admin.attributes')}}"
                                                                                            data-i18n="nav.dash.ecommerce"> {{__('admin/sidebar.all')}} </a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.attributes.create')}}" data-i18n="nav.dash.crypto">{{__('admin/products.products create')}}  </a>
                    </li>
                </ul>
            </li>
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                ...
                <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">{{__('admin/sidebar.shipping methods')}}</a>
                        <ul class="menu-content">
                            ...
                            <li><a class="menu-item" href="{{route('edit.shipping','inner')}}"> {{__('admin/sidebar.shipping inner')}}</a>
                            </li>
                    ...
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">Main slider</a>
                        <ul class="menu-content">
